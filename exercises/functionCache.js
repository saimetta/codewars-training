function cache(func) {
  var cache = {};
  return function () {	
  	var key = arguments.length?JSON.stringify(arguments):'emptyKey';
  	if (!cache[key]) cache[key] = {'val': func.apply(null,arguments)};
...
In this case we want you to create a function wrapper, which takes a function and caches
 its results depending on the arguments, that were applied to the function.
