function digPow(n, p){
  var sum = (n+'').split('').reduce(function (previous,current,index){
  	return previous + Math.pow(parseInt(current),index+p)
  },0);
...
positive integer p we want to find a positive integer k, 
if it exists, such as the sum of the digits of n taken to the successive powers of p 
